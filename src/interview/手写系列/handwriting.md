...
function myInstanceof(paramL, paramR) {
  if (!paramL || (typeof paramL !== "object" && typeof paramL !== "function")) {
    return false;
  }
...
```javascript
Function.prototype.myApply = function (context, reset) {
  context =
    context === undefined || context === null ? globalThis : Object(context);
  reset = Array.isArray(reset) ? reset : [];
...
Function.prototype.myBind = function (context = window, ...args) {
  ...
  context =
    context === undefined || context === null ? globalThis : Object(this);
  let self = this;
...
const debounce = <T extends (...args: any[]) => any>(
  ...
  const debounced = function (...rest: Parameters<T>): ReturnType<T> | void {
    if (immediate) {
      let callNow = !timer;
